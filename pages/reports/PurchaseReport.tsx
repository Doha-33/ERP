...
export const PurchaseReport: React.FC = () => {
  ...
  const columns: Column<PurchaseReportData>[] = [
    ...
    { header: t('purchase_qty'), accessorKey: 'purchaseQty' },
    { header: t('purchase_amount'), accessorKey: 'purchaseAmount' },
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-blue-900 dark:text-white">{t('purchase_report')}</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm">{t('view_purchase_report')}</p>
        </div>
