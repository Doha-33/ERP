...
export const InventoryReport: React.FC = () => {
  ...
  const columns: Column<InventoryReportData>[] = [
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-blue-900 dark:text-white">{t('inventory_report')}</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm">{t('view_inventory_report')}</p>
        </div>
