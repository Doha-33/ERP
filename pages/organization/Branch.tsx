...
export const BranchPage: React.FC = () => {
  ...
  const { branches, companies, addBranch, updateBranch, deleteBranch } =
    useData();
        ...
        render: (b) => (
          <div className="flex items-center justify-center gap-2">
            <button
              ...
              className="p-1.5 text-gray-500 hover:text-white hover:bg-black rounded border border-gray-300 dark:border-gray-600 transition-colors"
            >
              <Edit2 size={14} />
            </button>
            <button
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        <div className="flex gap-3">
          ...
          <Button
            ...
            className="bg-[#4361EE] hover:bg-blue-700"
          >
          ...
          <div className="w-48">
            <div className="relative">
              ...
              >
                ...
                {Array.from(new Set(branches.map((b) => b.name))).map(
                  (name) => (
