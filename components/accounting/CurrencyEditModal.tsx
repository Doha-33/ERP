...
export const CurrencyEditModal: React.FC<CurrencyEditModalProps> = ({
  isOpen,
  onClose,
  selectedCurrency,
  onSave,
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid gap-x-8 gap-y-4">
          ...
          <div className="space-y-1">
            ...
            <Select
              name="isBaseCurrency"
              defaultValue={selectedCurrency?.isBaseCurrency ? 'true' : 'false'}
              options={[
          ...
          <div className="space-y-1">
            ...
            <Select
              name="isActive"
              defaultValue={selectedCurrency?.isActive ? 'true' : 'false'}
              options={[
