  ...
  return (
    <header className="h-16 bg-white dark:bg-dark-surface border-b border-gray-100 dark:border-dark-border flex items-center justify-between px-4 lg:px-8 sticky top-0 z-10 transition-colors">
        ...
        <div className="hidden md:block w-96">
          <div className="relative">
             ...
             <input 
                ...
                className="w-full pl-10 rtl:pr-10 rtl:pl-4 pr-4 py-2 bg-gray-50 dark:bg-dark-bg/50 border-none rounded-lg text-sm focus:ring-1 focus:ring-primary"
             />
             <div className="absolute right-3 rtl:left-3 rtl:right-auto top-1/2 -translate-y-1/2 px-1.5 py-0.5 bg-white dark:bg-dark-border rounded text-xs text-gray-400 border border-gray-200 dark:border-dark-border-strong">⌘K</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <button className="relative p-2 text-gray-500 hover:text-primary hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
          <Bell size={20} />
