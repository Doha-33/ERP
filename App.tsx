...
import { OvertimeReport } from "./pages/reports/hr/OvertimeReport";
import { DocumentsExpiryReport } from "./pages/reports/hr/DocumentsExpiryReport";
import { TurnoverReport } from "./pages/reports/hr/TurnoverReport";
import { HeadcountGrowthReport } from "./pages/reports/hr/HeadcountGrowthReport";
import { SalaryTrendReport } from "./pages/reports/hr/SalaryTrendReport";
import { DepartmentCostReport } from "./pages/reports/hr/DepartmentCostReport";
import { LeaveBalanceReport } from "./pages/reports/hr/LeaveBalanceReport";
import { PayrollVarianceReport } from "./pages/reports/hr/PayrollVarianceReport";
import { PromotionHistoryReport } from "./pages/reports/hr/PromotionHistoryReport";
import { HiringReport } from "./pages/reports/hr/HiringReport";
...
import { CRMProvider } from "./context/crm/CRMContext";
